...
public class Game1Activity extends BaseActivity implements View.OnClickListener {
    ...
    private ImageView gameImZ2;
    private ImageView gameImL2;
    private ImageView gameImL1;
    private ImageView gameImR1;
    private ImageView gameImR2;
    ...
    protected void initViews() {
        ...
        gameImZ2 =  findViewById(R.id.game_im_z2);//电子游戏
        gameImL2 =  findViewById(R.id.game_im_l2);//彩票游戏
        gameImL1 =  findViewById(R.id.game_im_l1);//真人咨询
        gameImR1 =  findViewById(R.id.game_im_r1);//体育赛事
        gameImR2 =  findViewById(R.id.game_im_r2);//棋牌游戏
  ...
  **/
    ...
    /**
      ...
      **/
        ...
        TranslateAnimation translateAnimation = new TranslateAnimation(-200, 100, -200, 0);//设置动画
        ...
        TranslateAnimation translateAnimation1= new TranslateAnimation(200, -100, 200, 0);//设置动画
